...
var keyword = "KDOTBLP_FRACTURE_CRITICAL_INSP_DOC_GENERAL";
var docTypeLabel = "Fracture Critical";
var documentsRootFolder = "support_doc_home";
var documentTypeHomeFolder = "support_doc_home_fc";
var documentsubTypeFolder  = "support_doc_home_fc_reports";
;
dynamic json = new System.Dynamic.ExpandoObject();
json.DocTypeKeyLabel = docTypeLabel;
json.DocSubTypeKeyLabel = "Reports";


var documentsRootFolderPath= System.Configuration.ConfigurationManager.AppSettings[documentsRootFolder];
var documentTypeHomeFolderPath = System.Configuration.ConfigurationManager.AppSettings[documentTypeHomeFolder];

var documentSubTypeFolderPath = System.Configuration.ConfigurationManager.AppSettings[documentsubTypeFolder];

json.DocumentsRootFolderPath = documentsRootFolderPath;
json.DocTypeHomeFolderPath = documentTypeHomeFolderPath;
json.DocSubTypeFolderPath = documentSubTypeFolderPath;

var dictionary = (IDictionary<string, object>)json;
var serialized = Newtonsoft.Json.JsonConvert.SerializeObject(dictionary);
